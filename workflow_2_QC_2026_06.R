...
### note: need to revise ggplot_stats, the linewidth
...
# Check the overall w_rot median, skip since we used the "double", 
######## only work for "planar fit".
...
prelim <- tribble(
  ...
  NA,                NA,               NA, NA,#"qc_GA_LI7200",     "qc_GA_LI7200", 
